v0.3.39
* Add support for importing GeoJSON and TopoJSON collections that contain mixed geometry types. (Polygons, polylines and points are imported to separate layers.)
